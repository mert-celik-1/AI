...
def interactive_chat():
    print("RAG Sohbet Asistanı (Çıkmak için 'q' yazın)")
    print("----------------------------------------------")

    language = input("Hangi dilde yanıt almak istersiniz? (Varsayılan: Türkçe): ") or "Türkçe"
    ...
    while True:
        ...
        response = chain_with_history.invoke(
            {"language": language, "question": clean_text(user_input)},
